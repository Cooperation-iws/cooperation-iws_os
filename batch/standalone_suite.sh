...
#cd /home/esmalif/cooperation/CVS/branch/Pro/ciws_fully_auto
#sudo ./cooperation-iws.py -c --createdirectories --isofile /home/esmalif/cooperation/ISO/debian_lenny_xfce_desktop.iso --modulesfile templates/dataManagementModulesList_standalone --webappmirror http://localhost:81/depot --debmirror http://localhost:3141/ftp.fr.debian.org/debian/ --debmirrornonfree http://localhost:3141/mirror.home-dn.net/debian-multimedia/ --debmirrorsecurity http://localhost:3141/security.debian.org/ --cms Joomla --directory /media/partage-dev/tmp/zba10a5 --host data --password cooperation --username ciwsadmin --artwork ciwsGnome --silent --outputisoname cooperation-iws-datamanagement-standalone-0.9.0.iso
...
#cd /home/esmalif/cooperation/CVS/branch/Pro/ciws_fully_auto
sudo ./cooperation-iws.py -c --createdirectories --isofile /home/esmalif/cooperation/ISO/debian_lenny_xfce_desktop.iso --modulesfile templates/eLearningModulesList_standalone --webappmirror http://localhost:81/depot --debmirror http://localhost:3141/ftp.fr.debian.org/debian/ --debmirrornonfree http://localhost:3141/mirror.home-dn.net/debian-multimedia/ --debmirrorsecurity http://localhost:3141/security.debian.org/ --cms Joomla --directory /media/partage-dev/tmp/zca10a7 --host elearning --password cooperation --username ciwsadmin --artwork ciwsGnome --silent --outputisoname cooperation-iws-elearning-standalone-0.9.0.iso
