...
sudo ./cooperation-iws.py -c --createdirectories --isofile /media/partage-dev/ISO/ubuntu-8.04.1-update-090310.iso --modulesfile templates/System/hosting_intranet --webappmirror http://localhost:81/depot --debmirror http://ciwsdev.cooperation-iws.intra:3142/fr.archive.ubuntu.com/ubuntu/ --debmirrornonfree http://ciwsdev.cooperation-iws.intra:3142/packages.medibuntu.org/ --debmirrorsecurity http://ciwsdev.cooperation-iws.intra:3142/fr.archive.ubuntu.com/ubuntu/ --cms Joomla --directory /media/partage-dev/tmp/zaaa31a9 --host social --password cooperation --username ciwsadmin --artwork ciwsGnome --silent --outputisoname cooperation-iws-socialwriter-intranet-0.8.0.iso --disautologin
