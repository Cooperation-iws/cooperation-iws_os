...
sudo ./cooperation-iws.py -c --createdirectories --dist debian --directory $working_path/test135 --outputisoname cooperation-iws-1c42e1d9b8024c0552ffd8c8ca2ab760-2011-02-22-10-24-21.iso --username ciwsadmin --userfullname ciws-user --password cooperation --host desk-server-5 --isofile $iso_path/jessie-bare-amd64-141214.iso --distvers jessie --modulesfile $template --webappmirror $webappmirror --debmirror $debian_deb_mirror --debmirrornonfree $debian_deb_mirror_nonfree --arch amd64 --debmirrorsecurity $debian_deb_mirror_security --artwork jessie --locale fr --keyblang fr --disautologin --silent --encryption luks --encryptionpassphrase 01234567890123456789
