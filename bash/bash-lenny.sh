...
sudo ./cooperation-iws.py -c --createdirectories --silent --artwork ciws_gnome --dist debian --directory $working_path/21 --outputisoname cooperation-iws-1c42e1d9b8024c0552ffd8c8ca2ab760-2011-02-22-10-24-20.iso --username ciwsadmin --password cooperation --host ciws-server --disautologin --encryption aes256 --encryptionpassphrase 04qwerty07197604121942* --isofile $iso_path/lenny_gnome_amd64_crypt.iso --distvers lenny --arch amd64-wheezy --modulesfile $template --webappmirror $webappmirror --debmirror $debian_deb_mirror --debmirrornonfree $debian_deb_mirror_nonfree --debmirrorsecurity $debian_deb_mirror_security >> $log_path/ls-2011-02-22-10-24-20-0-1c42e1d9b8024c0552ffd8c8ca2ab760.log
