...
template="/home/esmalif/livescript/livescripts-trunk/bash/templates/template-test-squeeze-amd64.sh"
...
sudo ./cooperation-iws.py -c --createdirectories --dist debian --directory $working_path/test373 --outputisoname cooperation-iws-dev-server-2-squeeze-amd64.iso --username esmalif --userfullname ciws-user --password Lokkir11 --host desk-server-3 --isofile $iso_path/debian-live-6.0.1-i386-gnome-desktop.iso --distvers squeeze --modulesfile $template --webappmirror $webappmirror --debmirror $debian_deb_mirror --debmirrornonfree $debian_deb_mirror_nonfree --arch amd64 --debmirrorsecurity $debian_deb_mirror_security --artwork wheezy --locale fr --keyblang fr --disautologin --encryption aes256 --encryptionpassphrase 04qwerty07197604121942* --silent
