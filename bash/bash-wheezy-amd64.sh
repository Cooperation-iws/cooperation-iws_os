...
template="/home/esmalif/livescript/livescripts-trunk/bash/templates/template-test-wheezy-amd64-1.3.x.sh"
...
sudo ./cooperation-iws.py -c --createdirectories --dist debian --directory $working_path/test389 --outputisoname cooperation-iws-1c42e1d9b8024c0552ffd8c8ca2ab760-2011-02-22-10-24-20.iso --username ciwsadmin --userfullname ciws-user --password cooperation --host ciws-server --isofile $iso_path/gnome-wheezy-amd64-120109-1.3.x.iso --distvers wheezy --modulesfile $template --webappmirror $webappmirror --debmirror $debian_deb_mirror --debmirrornonfree $debian_deb_mirror_nonfree --arch amd64-wheezy --debmirrorsecurity $debian_deb_mirror_security --artwork wheezy --locale fr --keyblang fr --disautologin --silent 
