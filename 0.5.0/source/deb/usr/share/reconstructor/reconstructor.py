...
#    Copyright (c) 2006-2008  Reconstructor Team <reconstructor@aperantis.com>
#
        ...
        try:
            ...
            if self.cdUbuntuVersion == self.dapperVersion:
                ...
                for l in f:
                    ...
                    conf += l
            # edgy/feisty/gutsy
            elif self.cdUbuntuVersion == self.edgyVersion or self.cdUbuntuVersion == self.feistyVersion or self.cdUbuntuVersion == self.gutsyVersion or self.cdUbuntuVersion == self.hardyVersion:
                # set live cd info
